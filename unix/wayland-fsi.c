...
int main( int argc, char **argv )
{
	...
	swigComment("----===< int constants >===-----\n");
	...
	#endif
	#ifdef WL_SHM_RELEASE
		swigIntConstant( WL_SHM_RELEASE, "WL_SHM_RELEASE" );
	#endif
		...
		swigIntConstant( WL_SHM_RELEASE_SINCE_VERSION, "WL_SHM_RELEASE_SINCE_VERSION" );
	#endif
	...
	#endif
	#ifdef WP_FRACTIONAL_SCALE_MANAGER_V1_DESTROY
		swigIntConstant( WP_FRACTIONAL_SCALE_MANAGER_V1_DESTROY, "WP_FRACTIONAL_SCALE_MANAGER_V1_DESTROY" );
	#endif
	#ifdef WP_FRACTIONAL_SCALE_MANAGER_V1_GET_FRACTIONAL_SCALE
		swigIntConstant( WP_FRACTIONAL_SCALE_MANAGER_V1_GET_FRACTIONAL_SCALE, "WP_FRACTIONAL_SCALE_MANAGER_V1_GET_FRACTIONAL_SCALE" );
	#endif
	#ifdef WP_FRACTIONAL_SCALE_MANAGER_V1_DESTROY_SINCE_VERSION
		swigIntConstant( WP_FRACTIONAL_SCALE_MANAGER_V1_DESTROY_SINCE_VERSION, "WP_FRACTIONAL_SCALE_MANAGER_V1_DESTROY_SINCE_VERSION" );
	#endif
	#ifdef WP_FRACTIONAL_SCALE_MANAGER_V1_GET_FRACTIONAL_SCALE_SINCE_VERSION
		swigIntConstant( WP_FRACTIONAL_SCALE_MANAGER_V1_GET_FRACTIONAL_SCALE_SINCE_VERSION, "WP_FRACTIONAL_SCALE_MANAGER_V1_GET_FRACTIONAL_SCALE_SINCE_VERSION" );
	#endif
	#ifdef WP_FRACTIONAL_SCALE_V1_DESTROY
		swigIntConstant( WP_FRACTIONAL_SCALE_V1_DESTROY, "WP_FRACTIONAL_SCALE_V1_DESTROY" );
	#endif
	#ifdef WP_FRACTIONAL_SCALE_V1_PREFERRED_SCALE_SINCE_VERSION
		swigIntConstant( WP_FRACTIONAL_SCALE_V1_PREFERRED_SCALE_SINCE_VERSION, "WP_FRACTIONAL_SCALE_V1_PREFERRED_SCALE_SINCE_VERSION" );
	#endif
	#ifdef WP_FRACTIONAL_SCALE_V1_DESTROY_SINCE_VERSION
		swigIntConstant( WP_FRACTIONAL_SCALE_V1_DESTROY_SINCE_VERSION, "WP_FRACTIONAL_SCALE_V1_DESTROY_SINCE_VERSION" );
	#endif
	#ifdef WP_VIEWPORTER_DESTROY
		swigIntConstant( WP_VIEWPORTER_DESTROY, "WP_VIEWPORTER_DESTROY" );
	#endif
	#ifdef WP_VIEWPORTER_GET_VIEWPORT
		swigIntConstant( WP_VIEWPORTER_GET_VIEWPORT, "WP_VIEWPORTER_GET_VIEWPORT" );
	#endif
	#ifdef WP_VIEWPORTER_DESTROY_SINCE_VERSION
		swigIntConstant( WP_VIEWPORTER_DESTROY_SINCE_VERSION, "WP_VIEWPORTER_DESTROY_SINCE_VERSION" );
	#endif
	#ifdef WP_VIEWPORTER_GET_VIEWPORT_SINCE_VERSION
		swigIntConstant( WP_VIEWPORTER_GET_VIEWPORT_SINCE_VERSION, "WP_VIEWPORTER_GET_VIEWPORT_SINCE_VERSION" );
	#endif
	#ifdef WP_VIEWPORT_DESTROY
		swigIntConstant( WP_VIEWPORT_DESTROY, "WP_VIEWPORT_DESTROY" );
	#endif
	#ifdef WP_VIEWPORT_SET_SOURCE
		swigIntConstant( WP_VIEWPORT_SET_SOURCE, "WP_VIEWPORT_SET_SOURCE" );
	#endif
	#ifdef WP_VIEWPORT_SET_DESTINATION
		swigIntConstant( WP_VIEWPORT_SET_DESTINATION, "WP_VIEWPORT_SET_DESTINATION" );
	#endif
	#ifdef WP_VIEWPORT_DESTROY_SINCE_VERSION
		swigIntConstant( WP_VIEWPORT_DESTROY_SINCE_VERSION, "WP_VIEWPORT_DESTROY_SINCE_VERSION" );
	#endif
	#ifdef WP_VIEWPORT_SET_SOURCE_SINCE_VERSION
		swigIntConstant( WP_VIEWPORT_SET_SOURCE_SINCE_VERSION, "WP_VIEWPORT_SET_SOURCE_SINCE_VERSION" );
	#endif
	#ifdef WP_VIEWPORT_SET_DESTINATION_SINCE_VERSION
		swigIntConstant( WP_VIEWPORT_SET_DESTINATION_SINCE_VERSION, "WP_VIEWPORT_SET_DESTINATION_SINCE_VERSION" );
	#endif
	...
	swigIntConstant( WL_SHM_FORMAT_C1, "WL_SHM_FORMAT_C1" );
	swigIntConstant( WL_SHM_FORMAT_C2, "WL_SHM_FORMAT_C2" );
	swigIntConstant( WL_SHM_FORMAT_C4, "WL_SHM_FORMAT_C4" );
	swigIntConstant( WL_SHM_FORMAT_D1, "WL_SHM_FORMAT_D1" );
	swigIntConstant( WL_SHM_FORMAT_D2, "WL_SHM_FORMAT_D2" );
	swigIntConstant( WL_SHM_FORMAT_D4, "WL_SHM_FORMAT_D4" );
	swigIntConstant( WL_SHM_FORMAT_D8, "WL_SHM_FORMAT_D8" );
	swigIntConstant( WL_SHM_FORMAT_R1, "WL_SHM_FORMAT_R1" );
	swigIntConstant( WL_SHM_FORMAT_R2, "WL_SHM_FORMAT_R2" );
	swigIntConstant( WL_SHM_FORMAT_R4, "WL_SHM_FORMAT_R4" );
	swigIntConstant( WL_SHM_FORMAT_R10, "WL_SHM_FORMAT_R10" );
	swigIntConstant( WL_SHM_FORMAT_R12, "WL_SHM_FORMAT_R12" );
	swigIntConstant( WL_SHM_FORMAT_AVUY8888, "WL_SHM_FORMAT_AVUY8888" );
	swigIntConstant( WL_SHM_FORMAT_XVUY8888, "WL_SHM_FORMAT_XVUY8888" );
	swigIntConstant( WL_SHM_FORMAT_P030, "WL_SHM_FORMAT_P030" );
	...
	swigIntConstant( WL_DATA_DEVICE_ERROR_USED_SOURCE, "WL_DATA_DEVICE_ERROR_USED_SOURCE" );
	...
	swigIntConstant( ZXDG_TOPLEVEL_DECORATION_V1_ERROR_INVALID_MODE, "ZXDG_TOPLEVEL_DECORATION_V1_ERROR_INVALID_MODE" );
	...
	swigIntConstant( WP_FRACTIONAL_SCALE_MANAGER_V1_ERROR_FRACTIONAL_SCALE_EXISTS, "WP_FRACTIONAL_SCALE_MANAGER_V1_ERROR_FRACTIONAL_SCALE_EXISTS" );
	swigIntConstant( WP_VIEWPORTER_ERROR_VIEWPORT_EXISTS, "WP_VIEWPORTER_ERROR_VIEWPORT_EXISTS" );
	swigIntConstant( WP_VIEWPORT_ERROR_BAD_VALUE, "WP_VIEWPORT_ERROR_BAD_VALUE" );
	swigIntConstant( WP_VIEWPORT_ERROR_BAD_SIZE, "WP_VIEWPORT_ERROR_BAD_SIZE" );
	swigIntConstant( WP_VIEWPORT_ERROR_OUT_OF_BUFFER, "WP_VIEWPORT_ERROR_OUT_OF_BUFFER" );
	swigIntConstant( WP_VIEWPORT_ERROR_NO_SURFACE, "WP_VIEWPORT_ERROR_NO_SURFACE" );
	...
	swigComment("struct wp_fractional_scale_v1_listener\n");
	printf( "begin-structure wp_fractional_scale_v1_listener\n" );
	swigStructField( "wp_fractional_scale_v1_listener-preferred_scale", offsetof( struct wp_fractional_scale_v1_listener, preferred_scale ), sizeof( void (*)(void *,struct wp_fractional_scale_v1 *,uint32_t) ) );
	printf( "drop %zu end-structure\n", sizeof( struct wp_fractional_scale_v1_listener ) );
	...
	swigFunctionPointer( "c-funptr wp_fractional_scale_v1_listener-preferred_scale() {((struct wp_fractional_scale_v1_listener*)ptr)->preferred_scale} a a u -- void", "", "", "	( data wp_fractional_scale_v1 scale -- )" );
...
#if WAYLAND_MIN_VER(1,23)
	swigFunction( "c-function wl_proxy_get_display wl_proxy_get_display a -- a", "FUNCTION: wl_proxy_get_display ( proxy -- a )", "EXTERN: \"C\" void * wl_proxy_get_display( void * proxy );", "	( proxy -- )" );
#endif
...
#if WAYLAND_MIN_VER(1,23)
	swigFunction( "c-function wl_proxy_get_queue wl_proxy_get_queue a -- a", "FUNCTION: wl_proxy_get_queue ( proxy -- a )", "EXTERN: \"C\" void * wl_proxy_get_queue( void * proxy );", "	( proxy -- )" );
#endif
#if WAYLAND_MIN_VER(1,23)
	swigFunction( "c-function wl_event_queue_get_name wl_event_queue_get_name a -- s", "FUNCTION: wl_event_queue_get_name ( queue -- s )", "EXTERN: \"C\" char * wl_event_queue_get_name( void * queue );", "	( queue -- )" );
#endif
...
#if WAYLAND_MIN_VER(1,23)
	swigFunction( "c-function wl_display_create_queue_with_name wl_display_create_queue_with_name a s -- a", "FUNCTION: wl_display_create_queue_with_name ( display name -- a )", "EXTERN: \"C\" void * wl_display_create_queue_with_name( void * display, char * name );", "	( display name -- )" );
#endif
...
#if WAYLAND_MIN_VER(1,23)
	swigFunction( "c-function wl_display_set_max_buffer_size wl_display_set_max_buffer_size a n -- void", "FUNCTION: wl_display_set_max_buffer_size ( display max_buffer_size -- void )", "EXTERN: \"C\" void wl_display_set_max_buffer_size( void * display, long max_buffer_size );", "	( display max_buffer_size -- )" );
#endif
...
#if WAYLAND_MIN_VER(1,23)
	swigFunction( "c-function wl_shm_release wl_shm_release a -- void", "FUNCTION: wl_shm_release ( wl_shm -- void )", "EXTERN: \"C\" void wl_shm_release( void * wl_shm );", "	( wl_shm -- )" );
#endif
	...
	swigFunction( "c-function wp_fractional_scale_manager_v1_set_user_data wp_fractional_scale_manager_v1_set_user_data a a -- void", "FUNCTION: wp_fractional_scale_manager_v1_set_user_data ( wp_fractional_scale_manager_v1 user_data -- void )", "EXTERN: \"C\" void wp_fractional_scale_manager_v1_set_user_data( void * wp_fractional_scale_manager_v1, void * user_data );", "	( wp_fractional_scale_manager_v1 user_data -- )" );
	swigFunction( "c-function wp_fractional_scale_manager_v1_get_user_data wp_fractional_scale_manager_v1_get_user_data a -- a", "FUNCTION: wp_fractional_scale_manager_v1_get_user_data ( wp_fractional_scale_manager_v1 -- a )", "EXTERN: \"C\" void * wp_fractional_scale_manager_v1_get_user_data( void * wp_fractional_scale_manager_v1 );", "	( wp_fractional_scale_manager_v1 -- )" );
	swigFunction( "c-function wp_fractional_scale_manager_v1_get_version wp_fractional_scale_manager_v1_get_version a -- u", "FUNCTION: wp_fractional_scale_manager_v1_get_version ( wp_fractional_scale_manager_v1 -- u )", "EXTERN: \"C\" int wp_fractional_scale_manager_v1_get_version( void * wp_fractional_scale_manager_v1 );", "	( wp_fractional_scale_manager_v1 -- )" );
	swigFunction( "c-function wp_fractional_scale_manager_v1_destroy wp_fractional_scale_manager_v1_destroy a -- void", "FUNCTION: wp_fractional_scale_manager_v1_destroy ( wp_fractional_scale_manager_v1 -- void )", "EXTERN: \"C\" void wp_fractional_scale_manager_v1_destroy( void * wp_fractional_scale_manager_v1 );", "	( wp_fractional_scale_manager_v1 -- )" );
	swigFunction( "c-function wp_fractional_scale_manager_v1_get_fractional_scale wp_fractional_scale_manager_v1_get_fractional_scale a a -- a", "FUNCTION: wp_fractional_scale_manager_v1_get_fractional_scale ( wp_fractional_scale_manager_v1 surface -- a )", "EXTERN: \"C\" void * wp_fractional_scale_manager_v1_get_fractional_scale( void * wp_fractional_scale_manager_v1, void * surface );", "	( wp_fractional_scale_manager_v1 surface -- )" );
	swigFunction( "c-function wp_fractional_scale_v1_add_listener wp_fractional_scale_v1_add_listener a a a -- n", "FUNCTION: wp_fractional_scale_v1_add_listener ( wp_fractional_scale_v1 listener data -- n )", "EXTERN: \"C\" int wp_fractional_scale_v1_add_listener( void * wp_fractional_scale_v1, void * listener, void * data );", "	( wp_fractional_scale_v1 listener data -- )" );
	swigFunction( "c-function wp_fractional_scale_v1_set_user_data wp_fractional_scale_v1_set_user_data a a -- void", "FUNCTION: wp_fractional_scale_v1_set_user_data ( wp_fractional_scale_v1 user_data -- void )", "EXTERN: \"C\" void wp_fractional_scale_v1_set_user_data( void * wp_fractional_scale_v1, void * user_data );", "	( wp_fractional_scale_v1 user_data -- )" );
	swigFunction( "c-function wp_fractional_scale_v1_get_user_data wp_fractional_scale_v1_get_user_data a -- a", "FUNCTION: wp_fractional_scale_v1_get_user_data ( wp_fractional_scale_v1 -- a )", "EXTERN: \"C\" void * wp_fractional_scale_v1_get_user_data( void * wp_fractional_scale_v1 );", "	( wp_fractional_scale_v1 -- )" );
	swigFunction( "c-function wp_fractional_scale_v1_get_version wp_fractional_scale_v1_get_version a -- u", "FUNCTION: wp_fractional_scale_v1_get_version ( wp_fractional_scale_v1 -- u )", "EXTERN: \"C\" int wp_fractional_scale_v1_get_version( void * wp_fractional_scale_v1 );", "	( wp_fractional_scale_v1 -- )" );
	swigFunction( "c-function wp_fractional_scale_v1_destroy wp_fractional_scale_v1_destroy a -- void", "FUNCTION: wp_fractional_scale_v1_destroy ( wp_fractional_scale_v1 -- void )", "EXTERN: \"C\" void wp_fractional_scale_v1_destroy( void * wp_fractional_scale_v1 );", "	( wp_fractional_scale_v1 -- )" );
	swigFunction( "c-function wp_viewporter_set_user_data wp_viewporter_set_user_data a a -- void", "FUNCTION: wp_viewporter_set_user_data ( wp_viewporter user_data -- void )", "EXTERN: \"C\" void wp_viewporter_set_user_data( void * wp_viewporter, void * user_data );", "	( wp_viewporter user_data -- )" );
	swigFunction( "c-function wp_viewporter_get_user_data wp_viewporter_get_user_data a -- a", "FUNCTION: wp_viewporter_get_user_data ( wp_viewporter -- a )", "EXTERN: \"C\" void * wp_viewporter_get_user_data( void * wp_viewporter );", "	( wp_viewporter -- )" );
	swigFunction( "c-function wp_viewporter_get_version wp_viewporter_get_version a -- u", "FUNCTION: wp_viewporter_get_version ( wp_viewporter -- u )", "EXTERN: \"C\" int wp_viewporter_get_version( void * wp_viewporter );", "	( wp_viewporter -- )" );
	swigFunction( "c-function wp_viewporter_destroy wp_viewporter_destroy a -- void", "FUNCTION: wp_viewporter_destroy ( wp_viewporter -- void )", "EXTERN: \"C\" void wp_viewporter_destroy( void * wp_viewporter );", "	( wp_viewporter -- )" );
	swigFunction( "c-function wp_viewporter_get_viewport wp_viewporter_get_viewport a a -- a", "FUNCTION: wp_viewporter_get_viewport ( wp_viewporter surface -- a )", "EXTERN: \"C\" void * wp_viewporter_get_viewport( void * wp_viewporter, void * surface );", "	( wp_viewporter surface -- )" );
	swigFunction( "c-function wp_viewport_set_user_data wp_viewport_set_user_data a a -- void", "FUNCTION: wp_viewport_set_user_data ( wp_viewport user_data -- void )", "EXTERN: \"C\" void wp_viewport_set_user_data( void * wp_viewport, void * user_data );", "	( wp_viewport user_data -- )" );
	swigFunction( "c-function wp_viewport_get_user_data wp_viewport_get_user_data a -- a", "FUNCTION: wp_viewport_get_user_data ( wp_viewport -- a )", "EXTERN: \"C\" void * wp_viewport_get_user_data( void * wp_viewport );", "	( wp_viewport -- )" );
	swigFunction( "c-function wp_viewport_get_version wp_viewport_get_version a -- u", "FUNCTION: wp_viewport_get_version ( wp_viewport -- u )", "EXTERN: \"C\" int wp_viewport_get_version( void * wp_viewport );", "	( wp_viewport -- )" );
	swigFunction( "c-function wp_viewport_destroy wp_viewport_destroy a -- void", "FUNCTION: wp_viewport_destroy ( wp_viewport -- void )", "EXTERN: \"C\" void wp_viewport_destroy( void * wp_viewport );", "	( wp_viewport -- )" );
	swigFunction( "c-function wp_viewport_set_source wp_viewport_set_source a n n n n -- void", "FUNCTION: wp_viewport_set_source ( wp_viewport x y width height -- void )", "EXTERN: \"C\" void wp_viewport_set_source( void * wp_viewport, int x, int y, int width, int height );", "	( wp_viewport x y width height -- )" );
	swigFunction( "c-function wp_viewport_set_destination wp_viewport_set_destination a n n -- void", "FUNCTION: wp_viewport_set_destination ( wp_viewport width height -- void )", "EXTERN: \"C\" void wp_viewport_set_destination( void * wp_viewport, int width, int height );", "	( wp_viewport width height -- )" );
