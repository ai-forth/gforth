...
int main( int argc, char **argv )
{
	...
	swigIntConstant( HB_SCRIPT_GARAY, "HB_SCRIPT_GARAY" );
	swigIntConstant( HB_SCRIPT_GURUNG_KHEMA, "HB_SCRIPT_GURUNG_KHEMA" );
	swigIntConstant( HB_SCRIPT_KIRAT_RAI, "HB_SCRIPT_KIRAT_RAI" );
	swigIntConstant( HB_SCRIPT_OL_ONAL, "HB_SCRIPT_OL_ONAL" );
	swigIntConstant( HB_SCRIPT_SUNUWAR, "HB_SCRIPT_SUNUWAR" );
	swigIntConstant( HB_SCRIPT_TODHRI, "HB_SCRIPT_TODHRI" );
	swigIntConstant( HB_SCRIPT_TULU_TIGALARI, "HB_SCRIPT_TULU_TIGALARI" );
...
/* 	printf( "drop %zu end-structure\n", sizeof( union _hb_var_num_t ) ); */
	...
	swigCallback( "c-callback hb_get_table_tags_func_t: a u a a a -- u", "", "", "	( face start_offset table_count table_tags user_data -- )" );
...
#endif
	swigFunction( "c-function hb_buffer_set_not_found_variation_selector_glyph hb_buffer_set_not_found_variation_selector_glyph a u -- void", "FUNCTION: hb_buffer_set_not_found_variation_selector_glyph ( buffer not_found_variation_selector -- void )", "EXTERN: \"C\" void hb_buffer_set_not_found_variation_selector_glyph( void * buffer, int not_found_variation_selector );", "	( buffer not_found_variation_selector -- )" );
	swigFunction( "c-function hb_buffer_get_not_found_variation_selector_glyph hb_buffer_get_not_found_variation_selector_glyph a -- u", "FUNCTION: hb_buffer_get_not_found_variation_selector_glyph ( buffer -- u )", "EXTERN: \"C\" int hb_buffer_get_not_found_variation_selector_glyph( void * buffer );", "	( buffer -- )" );
#if HB_MIN_VER(8,4)
	swigFunction( "c-function hb_buffer_set_random_state hb_buffer_set_random_state a u -- void", "FUNCTION: hb_buffer_set_random_state ( buffer state -- void )", "EXTERN: \"C\" void hb_buffer_set_random_state( void * buffer, int state );", "	( buffer state -- )" );
#endif
#if HB_MIN_VER(8,4)
	swigFunction( "c-function hb_buffer_get_random_state hb_buffer_get_random_state a -- u", "FUNCTION: hb_buffer_get_random_state ( buffer -- u )", "EXTERN: \"C\" int hb_buffer_get_random_state( void * buffer );", "	( buffer -- )" );
#endif
	...
	swigFunction( "c-function hb_face_create_or_fail hb_face_create_or_fail a u -- a", "FUNCTION: hb_face_create_or_fail ( blob index -- a )", "EXTERN: \"C\" void * hb_face_create_or_fail( void * blob, int index );", "	( blob index -- )" );
	swigFunction( "c-function hb_face_create_from_file_or_fail hb_face_create_from_file_or_fail s u -- a", "FUNCTION: hb_face_create_from_file_or_fail ( file_name index -- a )", "EXTERN: \"C\" void * hb_face_create_from_file_or_fail( char * file_name, int index );", "	( file_name index -- )" );
	...
	swigFunction( "c-function hb_face_set_get_table_tags_func hb_face_set_get_table_tags_func a a a a -- void", "FUNCTION: hb_face_set_get_table_tags_func ( face func user_data destroy -- void )", "EXTERN: \"C\" void hb_face_set_get_table_tags_func( void * face, void * func, void * user_data, void * destroy );", "	( face func user_data destroy -- )" );
	...
	swigFunction( "c-function hb_ft_face_create_from_file_or_fail hb_ft_face_create_from_file_or_fail s u -- a", "FUNCTION: hb_ft_face_create_from_file_or_fail ( file_name index -- a )", "EXTERN: \"C\" void * hb_ft_face_create_from_file_or_fail( char * file_name, int index );", "	( file_name index -- )" );
