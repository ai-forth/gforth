...
typedef struct {
  ...
  size_t size;
	...
	swigComment("struct texture_atlas_t\n");
	...
	swigComment("struct texture_glyph_t\n");
	...
	swigComment("struct texture_font_library_t\n");
	...
	swigComment("struct texture_font_t\n");
	...
	swigFunction( "c-function texture_atlas_get_region texture_atlas_get_region a n n -- t{*(ivec4*)}", "FUNCTION: texture_atlas_get_region ( self width height -- struct )", "EXTERN: \"C\" struct texture_atlas_get_region( void * self, int width, int height );", "	( self width height -- )" );
