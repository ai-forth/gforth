...
if (VM_IS_INST(*ip, 440)) {
  add_inst(b, "forget-dyncode3");
  ip += 1;
  goto _endif_;
}
if (VM_IS_INST(*ip, 441)) {
  add_inst(b, "decompile-prim3");
  ip += 1;
  goto _endif_;
}
